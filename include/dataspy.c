...
//void  DataSpy::dataSpyVerbose(int opt){verbose = opt;}
...
*/
/*
int DataSpy::dataSpyOpen (int id)
{
...
*/
/*
int DataSpy::dataSpyClose (int id)
{
  int ret;
...
*/
/*
int DataSpy::dataSpyReadWithSeq (int id, char *data, int length, int *seq)
{
  int next,index;
  int * bufferaddress;
  int i,len;
...
int DataSpy::dataSpyRead (int id, char *data, int length) {
   int seq;
